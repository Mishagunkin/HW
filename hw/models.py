...
class Booking(models.Model):
    user = models.ForeignKey(Traveler, on_delete=models.CASCADE, verbose_name='Арендатор')
    hotel = models.ForeignKey(Hotel, on_delete=models.CASCADE, verbose_name='Автомобиль')
    ...
    booking_date = models.DateTimeField(default=now, blank=False,verbose_name='Дата аренды')
